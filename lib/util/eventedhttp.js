...
EventedHTTPServer.prototype.close = function(callback) {
  that = this;
  this._tcpServer.close(function(){console.log("CLOSED");callback()});
  console.log("@@");
  for (var i=0;i<this._connections.length;i++) {
    var connection = this._connections[i];
    console.log("!!!");
    connection._clientSocket.destroy();
    connection._httpServer.close();
  };
}
